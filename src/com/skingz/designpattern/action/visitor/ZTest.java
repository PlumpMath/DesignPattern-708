...
public class ZTest {
	...
	public static void main(String[] args) {
        ...
        fte1 = new EmployeeFulltime("张无忌",3200.00,45);    
        fte2 = new EmployeeFulltime("杨过",2000.00,40);    
        fte3 = new EmployeeFulltime("段誉",2400.00,38);    
        pte1 = new EmployeeParttime("洪七公",80.00,20);    
        pte2 = new EmployeeParttime("郭靖",60.00,18);    
